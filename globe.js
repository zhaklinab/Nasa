...
var selectedCountryFill = "#007ea3",
    ...
    landFill = "#b9b5ad",
    seaFill = "#e9e4da";
var startCountry = prompt("Enter Your Departure Country");
var endCountry = prompt("Enter Your Destination Country");
var radiationDose = document.getElementById('#radiationDose');
var cumulativeDose = document.getElementById('#cumulativeDose');
var standardDose = document.getElementById('#standardDose');

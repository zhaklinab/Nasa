        ...
        <div class="mdl-grid">
          <div class="mdl-cell mdl-cell--4-col">
            <ul  class="demo-list-item mdl-list" id="outUp">
              ...
              <li class="mdl-list__item" style="color:white !important;"><span class="mdl-list__item-primary-content">If you are pregnant and aware of an ongoing solar particle event when you are scheduled to fly you may want to consider trip-trading or other rescheduling actions if possible.
